...
# Sanitize: strip embedded newlines/carriage-returns so an attacker-controlled
# forgejo_api_url input cannot inject additional key=value pairs into GITHUB_OUTPUT.
